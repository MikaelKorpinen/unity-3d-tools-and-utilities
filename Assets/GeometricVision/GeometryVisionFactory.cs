...
namespace GeometricVision
{
    public class GeometryVisionFactory
    {
            ...
            GeometryVisionEye eye, GeometryType geoType, int layerIndex)
        {
            ...
            geoVision.GetComponent<GeometryVisionHead>().Eye.geometryTypes = new VisionTarget[1];
            var visionTarget1 = new VisionTarget(geoType,layerIndex);
            geoVision.GetComponent<GeometryVisionHead>().Eye.geometryTypes[0] = visionTarget1;
            return geoVision;
        }
